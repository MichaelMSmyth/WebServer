// This is the controller section of the 'Model, View, Controller' design pattern. The controller only handles request flow and should not perform any logic regarding the data itself.
